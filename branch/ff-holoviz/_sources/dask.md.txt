...
the most [commonly used methods are available](https://docs.dask.org/en/stable/dataframe.html#scope).
...
Dask has much in common with the [Apache Spark](https://spark.apache.org/).
Here are [some differences](https://docs.dask.org/en/stable/spark.html)
